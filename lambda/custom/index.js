...
const LaunchRequest = {
  ...
  async handle(handlerInput) {
    ...
    const speechText = `Welcome to High Low custom code. You have played ${gamesPlayed} times. Would you like to play?`
...
const ErrorHandler = {
  ...
  handle(handlerInput, error) {
    ...
    return handlerInput.responseBuilder
      .speak(`Sorry, I can\'t understand that command. Please say again`)
      .reprompt(`Sorry, I can\'t understand that command. Please say again.`)
      .getResponse();
  },
};
